export default function Hero() {
  return (
    <section className="relative w-full min-h-0 bg-gradient-to-b from-primary/10 to-background flex items-start justify-center overflow-hidden pt-6 pb-10 md:pt-8 md:pb-16">
      {/* Background Elements */}
